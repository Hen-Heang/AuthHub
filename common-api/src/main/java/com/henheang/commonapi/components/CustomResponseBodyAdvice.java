...
import com.kosign.wepoint.common.components.common.api.ApiResponse;
import com.kosign.wepoint.common.components.common.api.Common;
...
public class CustomResponseBodyAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body,
        ...
        if (serverHttpRequest instanceof ServletServerHttpRequest && serverHttpResponse instanceof ServletServerHttpResponse) {
            ...
            if (Stream.of("/api/wpc").anyMatch(request.getRequestURI()::contains)) {
                adminLoggingService.logResponse(request, response, body);
            }

            if (Stream.of("/api/client").anyMatch(request.getRequestURI()::contains)) {
                openApiLoggingService.logResponse(request, response, body);
            }
        }
